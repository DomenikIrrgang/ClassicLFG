...
ClassicLFG.DungeonManager:DefineDungeon("The Deadmines", 5, 14, 24, "Westfall", "DM", {"dm", "vc", "deadmines"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-DEADMINES")
...
ClassicLFG.DungeonManager:DefineDungeon("Gnomeregan", 5, 25, 35, "Dun Morogh", "gnomeregan", {"gnomeregan", "gnomer"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-GNOMEREGAN")
