...
ClassicLFG.DungeonManager:DefineDungeon("The Scarlet Monastery: Graveyard", 5, 25, 35, "Tirisfal Glades", "graveyard", {"sm", "gy", "friedhof", "fried"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
