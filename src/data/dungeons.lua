...
ClassicLFG.DungeonManager:DefineDungeon("The Scarlet Monastery: Graveyard", 5, 25, 35, "Tirisfal Glades", "sm graveyard", {"gy", "graveyard", "sm gy"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG.DungeonManager:DefineDungeon("The Scarlet Monastery: Library", 5, 29, 39, "Tirisfal Glades", "sm library", {"sm lib", "lib", "library"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG.DungeonManager:DefineDungeon("The Scarlet Monastery: Armory", 5, 32, 42, "Tirisfal Glades", "sm armory", {"armory", "sm arm"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG.DungeonManager:DefineDungeon("The Scarlet Monastery: Cathedral", 5, 34, 44, "Tirisfal Glades", "sm cathedral", {"sm cath", "cath", "cathedral"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG.DungeonManager:DefineDungeon("Razorfen Downs", 5, 33, 43, "Barrens", "rfd", {"rfd", "razorfen downs"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-RAZORFENDOWNS")
