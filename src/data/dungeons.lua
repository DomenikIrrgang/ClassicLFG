...
ClassicLFG.DungeonManager:DefineDungeon("The Scarlet Monastery: Library", 5, 29, 39, "Tirisfal Glades", "library", {"lib", "library", "bücherrei", "bibi"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
