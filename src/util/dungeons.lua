...
ClassicLFG:DefineDungeon("The Stockades", 5, 21, 30, "Stormwind", {"stockades"}, ClassicLFG.Faction.ALLIANCE, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-STORMWINDSTOCKADES")
ClassicLFG:DefineDungeon("Gnomeregan", 5, 26, 35, "Dun Morogh", {"gnomeregan"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-GNOMEREGAN")
...
ClassicLFG:DefineDungeon("The Scarlet Monastery: Graveyard", 5, 26, 35, "Tirisfal Glades", {"SM GY"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG:DefineDungeon("The Scarlet Monastery: Library", 5, 30, 39, "Tirisfal Glades", {}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG:DefineDungeon("The Scarlet Monastery: Armory", 5, 33, 42, "Tirisfal Glades", {}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
ClassicLFG:DefineDungeon("The Scarlet Monastery: Cathedral", 5, 35, 44, "Tirisfal Glades", {}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SCARLETMONASTERY")
