...
ClassicLFG:DefineDungeon("Temple of Atal'Hakkar", 5, 47, 60, "Swamp of Sorrows", {"toa", "atal", "st"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\UI-LFG-BACKGROUND-SUNKENTEMPLE")
...
ClassicLFG:DefineDungeon("Onyxia's Lair", 40, 60, 60, "Dustwallow Marsh", {"ony", "onyxia", "ol"}, ClassicLFG.Faction.BOTH, "Interface\\LFGFRAME\\LFGIcon-OnyxiaEncounter")
